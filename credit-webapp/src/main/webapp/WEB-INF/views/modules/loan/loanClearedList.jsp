...
<ul id="nav-tabs" class="nav nav-tabs">
    <li class="active"><a href="#home" data-toggle="tab"> 已结清列表</a></li>
    <%--<li><a href="#profile" data-toggle="tab">新增客户</a></li>--%>
</ul>
<div id="tab-content" class="tab-content">
    <div id="home" class="tab-pane fade active in">
        <div class="alert alert-danger">
            <form class="form-inline" method="get" action="/loan/cleared/list">
        ...
        <table class="table table-bordered table-striped">
            ...
            <c:forEach items="${result.paging.list}" var="loan" varStatus="status">
                <tr>
                    ...
                    <td><fmt:formatDate value="${loan.lendTime}" pattern="yyyy-MM-dd"/></td>
        ...
        <nav>
            <ul class="pagination">
                <li><a href="${ctx}loan/cleared/list?pageNum=1">首页</a></li>
                <c:if test="${result.paging.pageNum > 1}">
                    <li><a href="${ctx}loan/cleared/list?pageNum=${result.paging.pageNum - 1}" aria-label="Previous">&laquo;</a></li>
                    <li><a href="${ctx}loan/cleared/list?pageNum=${result.paging.pageNum - 1}">${result.paging.pageNum - 1}</a></li>
                </c:if>
                <li class="active"><a href="javascript:;">${result.paging.pageNum}</a></li>

                <c:if test="${result.paging.pageNum + 1 <= result.paging.pageCount}">
                    <li><a href="${ctx}loan/cleared/list?pageNum=${result.paging.pageNum + 1}">${result.paging.pageNum + 1}</a></li>
                    <li><a href="${ctx}loan/cleared/list?pageNum=${result.paging.pageNum + 1}" aria-label="Next">&raquo;</a></li>
                </c:if>
                <li><a href="${ctx}loan/cleared/list">最后一页</a></li>
