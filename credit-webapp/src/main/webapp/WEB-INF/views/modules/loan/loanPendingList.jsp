...
<body>
<input type="hidden" value="放款详情" id="addTabTitle">
...
<div id="tab-content" class="tab-content">
        ...
        <table class="table table-bordered table-striped">
            ...
            <c:forEach items="${result.paging.list}" var="loan" varStatus="status">
                <tr>
                    ...
                    <td><a href="javascript:;" class="add-tab" onclick="showTabConent('${loan.customerCode}', '${loan.loanNo}')">${loan.loanNo}</a></td>
                    ...
                    <td>${loan.contractAmount}</td>
                    <td><a href="#detail" class="add-tab" onclick="setRelease(${loan.tid}, ${loan.contractAmount}, '${loan.customerCode}', '${loan.loanNo}')">放款</a></td>
                </tr>
    ...
    <div id="detail" class="tab-pane fade">
        ...
        <div class="content">
            <form action="/loan/release" enctype="multipart/form-data" method="post">
            <ul class="list-unstyled">
                <li class="row form-inline">
                    <span class="col-md-3">
                        <div class="form-group">
                            <label>放款金额：</label>
                            <input id="lendAmount" type="text" class="form-control" name="lendAmount">
                            <input id="loanTid" name="tid" type="hidden">
                        </div>
                    </span>
                </li>
                <li class="row form-inline">
                    <span class="col-md-3">
                        <div class="form-group">
                        <label>放款日期：</label>
                        <input id="" name="lendTime" class="Wdate" onfocus="WdatePicker({readOnly:true,maxDate:'%y-%M-%d'})" />
                        </div>
                    </span>
                </li>
                <li class="row form-inline">
                    <span class="col-md-3">
                        <div class="form-group">
                        <label for="file">放款附件：</label>
                        <%--<label><input name="file" id="file" type="file" class="hidden"><span class="btn btn-default">选择文件</span></label>--%>
                        <label><input name="file" id="file" type="file"></label>
                        </div>
                    </span>
                </li>
                <li class="row form-inline">
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            ...
            <div class="form-group">
                    <form class="form-horizontal" enctype="multipart/form-data" type="post" action="/loan/release">
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    // 根据选择的贷款条目， 为放款金额赋值
    function setRelease(tid, amount, custCode, loanNo) {
        $("#loanTid").val(tid);
        $("#lendAmount").val(amount);
