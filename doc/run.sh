...
#            \033[0m"
            ...
            echo -e "\033[35m start server nohup nice java -jar crm-batch-0.0.1-SNAPSHOT.jar --spring.profiles.active=staging > $logPath/server-start/crm-batch-staging-start.log 2>&1 & echo $! > $runPidPath/crm-batch-staging.pid
            \033[0m"
        elif [[ "worker" == "$appName" ]]; then
            ...
            echo -e "\033[35m start server nohup nice java -jar crm-web-sse-0.0.1-SNAPSHOT.jar --spring.profiles.active=staging > $logPath/server-start/crm-web-sse-staging-start.log 2>&1 & echo $! > $runPidPath/crm-web-sse-staging.pid
            \033[0m"
        elif [[ "api" == "$appName" ]]; then
            nohup nice java -Xmx256m -jar crm-web-api-0.0.1-SNAPSHOT.jar --spring.profiles.active=staging1 > $logPath/server-start/crm-web-api-staging-start.log 2>&1 & echo $! > $runPidPath/crm-web-api-staging.pid
